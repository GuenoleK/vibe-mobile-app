    ...
    if (
      ...
      axios
        ...
        .then(response => {
          if (response && response.status >= 200 && response.status <= 300) {
            snackbarStore.openSnackbar(
              ...
              translationUtil.translate("registration.message.success")
            );
          } else if (response && response.status !== 200) {
            snackbarStore.openSnackbar(
              SnackbarTypeEnum.ERROR,
              translationUtil.translate("registration.message.error")
            );
        ...
        .catch(e => {
          ...
          snackbarStore.openSnackbar(
            SnackbarTypeEnum.ERROR,
            translationUtil.translate(error.data.message)
          );
          throw new Error(
      ...
      snackbarStore.openSnackbar(
        ...
        translationUtil.translate("registration.message.warningFields")
      );
